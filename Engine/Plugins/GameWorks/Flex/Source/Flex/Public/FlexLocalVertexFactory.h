...
/**
* NOTE: This is a copy of FLocalVertexFactory that uses Flex specific shader code.
*
* A vertex factory which simply transforms explicit vertex attributes from local to world space.
*/
class ENGINE_API FFlexLocalVertexFactory : public FVertexFactory
{
	DECLARE_VERTEX_FACTORY_TYPE(FFlexLocalVertexFactory);
public:
